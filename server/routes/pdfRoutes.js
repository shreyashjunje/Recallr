...
const {uploadPdf,deletePdf,editPdf,downloadPdf, getAllPdfs, getPdfDetail, generateSummaryOnly, generateFlashCardsOnly, updatePdfProgress} = require('../controllers/pdfController');
const { authMiddleware } = require('../middlewares/auth');

router.post("/upload-pdf",authMiddleware,uploadTelegram.single('file'),uploadPdf);
