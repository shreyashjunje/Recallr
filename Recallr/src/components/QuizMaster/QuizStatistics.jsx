      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-500">
            We're gathering your performance data...
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          {/* Performance Chart */}
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6 lg:col-span-2">
            ...
            <div className="space-y-5">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="font-medium text-gray-900 dark:text-white overflow-hidden">
                    {stats.avgScore}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                  <div
                    ...
                    style={{
                      width: `${500 - stats.avgScore - stats.avgScore}%`,
                    }}
                  ></div>
                </div>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6 mb-8">
          <div className="flex justify-between items-center mb-6">
            ...
            <button className="text-indigo-600 hover:text-indigo-800 dark:hover:text-indigo-400 text-sm font-medium flex items-center">
          ...
          {stats.recentAttempts.length === 0 ? (
            <div className="text-center py-10">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Complete your first quiz to see statistics here.
              </p>
...
function StatCard({ title, value, icon, gradient, trend }) {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-5 overflow-hidden">
