...
export function QuizNavigation({
  ...
  showQuestionGrid,
  onToggleQuestionGrid,
  onSubmitQuiz, // Add this new prop
}) {
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        {isLastQuestion ? (
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-xl transition-all duration-200"
          >
            <CheckCircle className="w-4 h-4" />
            <span>Submit Quiz</span>
          </button>
        ) : (
          // Next button (for all other questions)
          <button
            onClick={onNext}
            className="flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-xl transition-all duration-200"
          >
