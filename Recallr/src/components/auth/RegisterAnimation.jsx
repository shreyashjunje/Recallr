...
export default function RegisterAnimation() {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 px-28 py-16 rounded-xl flex items-center justify-center border border-gray-200 shadow-lg">
      <div className="relative">
        ...
        >
          <div className="w-64 h-[480px] bg-gradient-to-br from-gray-800 to-gray-900 rounded-[2.5rem] p-2 shadow-2xl">
            <div className="w-full h-full bg-white rounded-[2rem] overflow-hidden relative flex flex-col">
              {/* Status bar - improved */}
              <motion.div 
                className="flex justify-between items-center px-4 pt-2 pb-1"
                ...
                <div className="space-y-3">
                  {[
                    ...
                    >
                      ...
                      <div className="h-8 w-full border border-gray-300 rounded-md"></div>
                    </motion.div>
                  ))}
                </div>
              </div>
        ...
        <motion.div 
          className="absolute -top-8 -left-8 w-16 h-16 bg-purple-200 rounded-full opacity-20"
          animate={{ scale: [1, 1.5, 1] }}
          transition={{ duration: 8, repeat: Infinity }}
        />
        <motion.div 
          className="absolute -bottom-8 -right-8 w-20 h-20 bg-blue-200 rounded-full opacity-20"
