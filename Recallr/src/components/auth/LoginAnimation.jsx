...
const LoginAnimation = () => {
    ...
    <>
      <style jsx>{`
        ...
        @keyframes pdf-float-1 {
          ...
          60% {
            transform: translateX(160px) translateY(-60px) rotate(-20deg)
              scale(0.9);
            opacity: 0.5;
          }
          100% {
            transform: translateX(240px) translateY(-90px) rotate(-35deg)
              scale(0.7);
            opacity: 0;
          }
        }
        ...
        @keyframes pdf-float-2 {
          0% {
            transform: translateX(0px) translateY(0px) rotate(-6deg) scale(1);
            opacity: 1;
          }
          30% {
            transform: translateX(70px) translateY(-40px) rotate(10deg)
              scale(1.1);
            opacity: 0.9;
          }
          60% {
            transform: translateX(140px) translateY(-80px) rotate(25deg)
              scale(0.9);
            opacity: 0.5;
          }
          100% {
            transform: translateX(210px) translateY(-120px) rotate(40deg)
              scale(0.7);
            opacity: 0;
          }
        }
        ...
        @keyframes pdf-float-3 {
          ...
          60% {
            transform: translateX(120px) translateY(-70px) rotate(-15deg)
              scale(0.9);
            opacity: 0.5;
          }
          100% {
            transform: translateX(180px) translateY(-105px) rotate(-25deg)
              scale(0.7);
            opacity: 0;
          }
        }
        ...
        @keyframes processing-particle-1 {
          ...
          100% {
            transform: translate(120px, -40px) scale(0);
            opacity: 0;
          }
        }
        ...
        @keyframes processing-particle-3 {
          ...
          50% {
            transform: translate(40px, 25px) scale(0.6);
            opacity: 0.6;
          }
          100% {
        ...
        @keyframes confetti-2 {
          ...
          100% {
            opacity: 0;
            transform: translateY(-220px) rotate(900deg);
          }
        }
        ...
        @keyframes confetti-3 {
          ...
          70% {
            opacity: 1;
            transform: translateY(-110px) rotate(630deg);
          }
          100% {
            opacity: 0;
            transform: translateY(-210px) rotate(1080deg);
          }
        }
  ...
  flex items-center justify-center"
      ...
      rounded-full animate-float-large-1 blur-sm"
          ></div>
          <div
            className="absolute bottom-32 right-16 w-40 h-40 
      bg-gradient-to-br from-blue-200/20 to-indigo-200/20 
      dark:from-blue-900/20 dark:to-indigo-900/20 
      rounded-full animate-float-large-2 blur-sm"
          ></div>
          <div
            className="absolute top-1/2 left-1/4 w-24 h-24 
      bg-gradient-to-br from-indigo-200/25 to-purple-200/25 
      dark:from-indigo-900/25 dark:to-purple-900/25 
      rounded-full animate-float-large-3 blur-sm"
          ></div>

          {/* Smaller particles */}
          <div className="absolute top-16 right-20 w-3 h-3 bg-purple-400 dark:bg-purple-600 rounded-full animate-particle-1"></div>
          <div className="absolute top-32 left-32 w-2 h-2 bg-blue-400 dark:bg-blue-600 rounded-full animate-particle-2"></div>
          <div className="absolute bottom-24 left-24 w-2.5 h-2.5 bg-indigo-400 dark:bg-indigo-600 rounded-full animate-particle-3"></div>
          <div className="absolute bottom-40 right-32 w-2 h-2 bg-purple-500 dark:bg-purple-700 rounded-full animate-particle-4"></div>
          <div className="absolute top-1/3 right-1/4 w-1.5 h-1.5 bg-blue-500 dark:bg-blue-700 rounded-full animate-particle-5"></div>

          {/* Geometric shapes */}
          <div className="absolute top-24 left-1/3 w-6 h-6 border-2 border-purple-300/40 dark:border-purple-700/40 rotate-45 animate-geometric-1"></div>
          <div className="absolute bottom-28 right-1/3 w-8 h-8 border-2 border-blue-300/40 dark:border-blue-700/40 animate-geometric-2"></div>
        </div>

        {/* Main Animation Container */}
        <div className="relative w-full h-full max-w-2xl">
          {/* KEEPING ALL YOUR EXISTING STAGES & ELEMENTS */}
          {/* --------------------------- */}
          {/* Stage 1 (Upload PDFs), Stage 2 (Processing), Stage 3 (Cards), Stage 4 (Success), 
        Characters, Icons, Machine, Feature Cards, Final Text, SVG Gradients */}
          {/* --------------------------- */}
          {/* ⬇️ Your entire code remains exactly as you provided ⬇️ */}

          {/* (PASTED ALL ORIGINAL CONTENT HERE WITHOUT CHANGES) */}
          ...
          <div className="absolute inset-0 animate-stage-1">
            ...
            <div className="absolute bottom-20 left-16 animate-character-upload">
              ...
              >
                ...
                {/* Hair */}
                <path
                  d="M 28 15 Q 40 8 52 15 Q 48 12 40 12 Q 32 12 28 15"
            ...
            <div className="absolute bottom-24 left-24 animate-character-celebrate">
              ...
              >
                ...
                <circle
                  ...
                  cy="25"
                  r="16"
                  fill="url(#characterGradientHappy)"
                  stroke="url(#characterStrokeHappy)"
                  strokeWidth="2"
                />
                <rect
                  x="32"
        ...
        rounded-3xl p-6 mx-8 shadow-xl 
        border border-purple-100 dark:border-gray-700"
            >
              ...
              <p className="text-2xl font-semibold text-indigo-700 dark:text-indigo-300 mb-2">
                and Learn Smarter
              </p>
