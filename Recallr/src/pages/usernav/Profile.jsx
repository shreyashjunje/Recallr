...
const ProfilePage = () => {
        ...
        {items.map((info, index) => {
          ...
          return (
            <motion.div
              ...
              dark:bg-gray-800/50 dark:hover:bg-gray-700/60 dark:border-white/10"
            >
              ...
              {info.editable && (
                <motion.button
                  ...
                  className="text-gray-400 hover:text-indigo-600 transition-colors duration-200 p-2 rounded-lg 
                  hover:bg-white/20 dark:hover:text-indigo-400 dark:hover:bg-gray-700/50"
                >
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
      ...
      >
        {/* Header Section */}
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl md:rounded-2xl shadow-lg md:shadow-xl border border-white/20 dark:border-gray-700/30 overflow-hidden">
          {/* Cover Photo */}
          <div className="h-40 sm:h-48 md:h-56 bg-gradient-to-r from-indigo-500 via-purple-500 to-cyan-500 relative">
            ...
            >
              <motion.button
                ...
                className="bg-white/20 dark:bg-gray-800/30 backdrop-blur-sm text-white px-3 py-2 sm:px-4 sm:py-2.5 md:px-5 md:py-3 rounded-lg md:rounded-xl hover:bg-white/30 dark:hover:bg-gray-800/40 transition-all duration-200 flex items-center justify-center space-x-2 font-medium text-xs sm:text-sm"
              >
          ...
          <div className="relative px-4 sm:px-6 md:px-8 pb-6 md:pb-8">
            <div className="flex flex-col lg:flex-row lg:items-end lg:space-x-6 -mt-16 md:-mt-20">
              <motion.div
                ...
                className="w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 bg-white dark:bg-gray-800 rounded-xl md:rounded-2xl p-1 shadow-xl md:shadow-2xl mb-4 lg:mb-0 relative mx-auto lg:mx-0"
              >
                {/* Avatar */}
              ...
              <div className="flex-1 text-center lg:text-left">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                  <div className="mb-4 sm:mb-0">
                    ...
                    <p className="text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-300 font-medium mb-2">
                      @{userData.userName}
                    </p>
                  ...
                  <div className="flex flex-wrap justify-center lg:justify-start items-center gap-2 mt-4 sm:mt-0">
                    <div className="bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400 px-2 py-1 text-xs sm:text-sm rounded-full font-medium">
                      ● Active
                    </div>
                    {userData.telegramChatId && (
                      <div className="bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400 px-2 py-1 text-xs sm:text-sm rounded-full font-medium">
                        Telegram Connected
                      </div>
                    )}
                  </div>
                </div>
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-6 max-w-3xl mx-auto lg:mx-0 leading-relaxed">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="xl:col-span-3 space-y-6 md:space-y-8">
            {/* Tabs */}
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl md:rounded-2xl shadow-lg md:shadow-xl border border-white/20 dark:border-gray-700/30 p-4 sm:p-5 md:p-6">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          onClick={() => setIsEditModalOpen(true)}
                          className="bg-gradient-to-br from-indigo-50 to-cyan-50 dark:from-indigo-900/30 dark:to-cyan-900/30 rounded-lg md:rounded-xl p-4 md:p-6 border border-indigo-100 dark:border-indigo-800/40 text-left hover:shadow-lg transition-all duration-200"
                        >
                          <Edit className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-indigo-600 dark:text-indigo-400 mb-2 md:mb-3" />
                        ...
                        <motion.button
                          ...
                          className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 rounded-lg md:rounded-xl p-4 md:p-6 border border-green-100 dark:border-green-800/40 text-left hover:shadow-lg transition-all duration-200"
                        >
                          <Key className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-green-600 dark:text-green-400 mb-2 md:mb-3" />
                          <h4 className="font-semibold text-gray-900 dark:text-white mb-1 text-sm sm:text-base">
                            Change Password
                          </h4>
                          <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">
                        ...
                        <motion.button
                          whileHover={{ scale: 1.02, y: -2 }}
                          whileTap={{ scale: 0.98 }}
                          className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/30 dark:to-pink-900/30 rounded-lg md:rounded-xl p-4 md:p-6 border border-purple-100 dark:border-purple-800/40 text-left hover:shadow-lg transition-all duration-200"
                        >
                          <MessageSquare className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-purple-600 dark:text-purple-400 mb-2 md:mb-3" />
                          <h4 className="font-semibold text-gray-900 dark:text-white mb-1 text-sm sm:text-base">
                            Telegram Settings
                          </h4>
                          <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                        <motion.div
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-lg md:rounded-xl p-4 md:p-6 border border-blue-100 dark:border-blue-800/40"
                        >
                        ...
                        <motion.div
                          ...
                          className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 rounded-lg md:rounded-xl p-4 md:p-6 border border-green-100 dark:border-green-800/40"
                        >
                          <div className="flex items-center space-x-3">
                        ...
                        <motion.div
                          ...
                          className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/30 dark:to-pink-900/30 rounded-lg md:rounded-xl p-4 md:p-6 border border-purple-100 dark:border-purple-800/40"
                        >
                          <div className="flex items-center space-x-3">
                        ...
                        <motion.div
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          transition={{ delay: 0.3 }}
                          className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/30 dark:to-red-900/30 rounded-lg md:rounded-xl p-4 md:p-6 border border-orange-100 dark:border-orange-800/40"
                        >
                          <div className="flex items-center space-x-3">
                  ...
                  <div className="space-y-4">
                    ...
                    userData.quizzes.length === 0 ? (
                      <div className="text-center py-8 md:py-12">
                        <BookOpen className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 text-gray-400 dark:text-gray-500 mx-auto mb-3 md:mb-4" />
                      ...
                      <div className="space-y-3 md:space-y-4">
                        <motion.div
                          initial={{ opacity: 0, y: 10 }}
                          animate={{ opacity: 1, y: 0 }}
                          className="bg-gray-50/50 dark:bg-gray-700/50 rounded-lg md:rounded-xl p-3 md:p-4 border border-gray-100 dark:border-gray-600/40 hover:bg-gray-50 dark:hover:bg-gray-700/70 transition-colors duration-200"
                        >
              ...
              <div className="space-y-4">
                ...
                {userData.favouritePdfs.length === 0 ? (
                  <div className="text-center py-8 md:py-12">
                    <Heart className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 text-gray-400 dark:text-gray-500 mx-auto mb-3 md:mb-4" />
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2">
                      No Favourites Yet
                    </h3>
                    <p className="text-gray-500 dark:text-gray-400 text-sm sm:text-base">
                  ...
                  <div className="space-y-3 md:space-y-4">
                    {userData.favouritePdfs.map((pdfId, index) => (
                      <motion.div
                        ...
                        className="bg-gradient-to-br from-pink-50 to-rose-50 dark:from-pink-900/30 dark:to-rose-900/30 rounded-lg md:rounded-xl p-3 md:p-4 border border-pink-100 dark:border-pink-800/40 hover:shadow-lg transition-all duration-200"
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <Heart className="w-4 h-4 sm:w-5 sm:h-5 text-pink-500 dark:text-pink-400 fill-current" />
                        </div>
                      </motion.div>
                    ))}
                  </div>
          ...
          <div className="xl:col-span-1 space-y-4 md:space-y-6">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.2 }}
              className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl md:rounded-2xl shadow-lg md:shadow-xl border border-white/20 dark:border-gray-700/30 p-4 md:p-6"
            >
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-4 md:mb-6">
                Your Stats
              </h3>
              <div className="space-y-3 md:space-y-4">
                {stats.map((stat, index) => {
                  ...
                  return (
                    <motion.div
                      key={index}
                      whileHover={{ scale: 1.02 }}
                      className="bg-gradient-to-br from-gray-50 to-indigo-50 dark:from-gray-700/50 dark:to-indigo-900/30 rounded-lg md:rounded-xl p-3 md:p-4 border border-gray-100 dark:border-gray-600/40 cursor-pointer"
                    >
                      <div className="flex items-center space-x-3">
              ...
              <div className="space-y-2 md:space-y-3">
                <div
                  className={`flex items-center justify-between p-2 md:p-3 rounded-lg md:rounded-xl ${
                    userData.telegramChatId
                      ? "bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700/40"
                      : "bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600/40"
                  }`}
                >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          <InfoSection
            ...
            items={personalInfo}
            bgColor="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm"
          />
          <InfoSection
