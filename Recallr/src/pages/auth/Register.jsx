...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
      <div className="  overflow-hidden bg-white shadow-2xl rounded-2xl  w-full max-w-6xl flex flex-col lg:flex-row lg:h-[90vh]">
