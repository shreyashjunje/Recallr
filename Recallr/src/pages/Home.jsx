...
const Home = () => {
  ...
  return (
    <div className={`w-full min-h-screen ${isDark ? "bg-gray-900 text-white" : "bg-white text-gray-900"}`}>
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className={`fixed inset-0 ${isDark ? "bg-gray-900" : "bg-white"} z-50 p-4`}>
      ...
      <button
        onClick={toggleTheme}
        className={`fixed top-4 right-4 z-50 p-2 rounded-full ${isDark ? "bg-gray-700 text-yellow-300" : "bg-gray-200 text-gray-700"}`}
      >
        {isDark ? <Sun className="w-5 h-5" /> : <Moon className="w-5 h-5" />}
      </button>
      
      <Navbar toggleMenu={toggleMenu} isDark={isDark} />
      
      {/* Hero Section */}
      <section className={`min-h-screen pt-16 lg:pt-24 ${isDark ? "bg-gradient-to-br from-gray-800 to-gray-900" : "bg-gradient-to-br from-blue-50 to-purple-50"} overflow-hidden`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <h1 className={`text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 sm:mb-6 ${isDark ? "text-white" : "text-gray-900"}`}>
                <span className="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">
                  Recallr
                </span>{" "}
                – Smarter PDFs, Smarter You
              </h1>
              <p className={`text-lg sm:text-xl mb-6 sm:mb-8 leading-relaxed ${isDark ? "text-gray-300" : "text-gray-600"}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                ...
                <a
                  href="#how-it-works"
                  className={`border-2 px-6 py-3 sm:px-8 sm:py-4 rounded-lg sm:rounded-xl text-base sm:text-lg font-semibold transition-all flex items-center justify-center ${isDark ? "border-gray-600 text-gray-300 hover:border-blue-500 hover:text-blue-400" : "border-gray-300 text-gray-700 hover:border-blue-500 hover:text-blue-500"}`}
                >
      ...
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12">
            {/* Problem */}
            <div className={`p-6 sm:p-8 rounded-xl sm:rounded-2xl ${isDark ? "bg-red-900/20" : "bg-red-50"}`}>
              ...
              <div className="mt-4 sm:mt-6 flex items-center text-red-500">
                <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center mr-3 sm:mr-4 ${isDark ? "bg-red-800/30" : "bg-red-100"}`}>
            ...
            {/* Solution */}
            <div className={`p-6 sm:p-8 rounded-xl sm:rounded-2xl ${isDark ? "bg-green-900/20" : "bg-green-50"}`}>
              ...
              <div className="mt-4 sm:mt-6 flex items-center text-green-500">
                <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center mr-3 sm:mr-4 ${isDark ? "bg-green-800/30" : "bg-green-100"}`}>
      ...
      <section id="features" className={`py-16 lg:py-24 ${isDark ? "bg-gray-800" : "bg-gray-50"}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className={`group p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 ${isDark ? "bg-gray-700 border-gray-600 hover:border-gray-500" : "bg-white border-gray-100 hover:border-gray-200"} border`}
              >
                <div
      ...
      <section
        id="how-it-works"
        className={`py-16 sm:py-20 lg:py-24 ${isDark ? "bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900" : "bg-gradient-to-b from-white via-gray-50 to-white"}`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
          <div className="text-center mb-14 sm:mb-20">
            <h2 className={`text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4 ${isDark ? "text-white" : "text-gray-900"}`}>
              How Recallr Works
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-10 relative">
            {[
              ...
              <div key={index} className="text-center relative group">
                ...
                <p className={`text-base sm:text-lg leading-relaxed max-w-xs mx-auto ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                  {step.description}
                </p>
      ...
      {/* CTA Section */}
<section className={`py-16 sm:py-20 lg:py-24 ${isDark ? "bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900" : "bg-gradient-to-br from-blue-500 to-purple-600"}`}>
  <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <motion.p
      ...
      className={`text-lg sm:text-xl mb-10 ${isDark ? "text-gray-300" : "text-blue-100"}`}
    >
    ...
    {/* You can add toast notifications or inline messages here */}
      ...
      {/* Footer */}
      <footer className={`py-8 sm:py-12 ${isDark ? "bg-gray-800 text-white" : "bg-gray-900 text-white"}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="sm:col-span-2">
              ...
              <p className={`text-sm sm:text-base mb-3 sm:mb-4 ${isDark ? "text-gray-400" : "text-gray-400"}`}>
                AI-powered PDF study assistant that helps you organize,
                summarize, and quiz yourself on your learning materials.
              </p>
              <p className={`text-sm sm:text-base ${isDark ? "text-gray-400" : "text-gray-400"}`}>
                Contact: recallr1825@gmail.com
              </p>
            </div>

            <div>
              <h4 className={`font-semibold text-sm sm:text-base mb-2 sm:mb-4 ${isDark ? "text-white" : "text-white"}`}>
                Product
              </h4>
          ...
          <div className={`border-t mt-6 sm:mt-8 pt-6 sm:pt-8 text-center text-sm sm:text-base ${isDark ? "border-gray-700 text-gray-400" : "border-gray-800 text-gray-400"}`}>
