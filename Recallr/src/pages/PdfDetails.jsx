            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-3 rounded-xl font-medium hover:from-blue-600 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                >
                  <Play size={18} />
                  Continue Reading
                </button>
                ...
                {pdf.isFlashcardGenerated ? (
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-orange-500 to-amber-500 text-white py-3 rounded-xl font-medium hover:from-orange-600 hover:to-amber-600 transition-all duration-200 shadow-lg hover:shadow-xl"
                    >
                      Start Studying
                    </button>
                  </div>
                ...
                {/* {(!pdf.isSummarized ||
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 border border-purple-100">
                    ...
                    <p className="text-gray-600 mb-4">
                      Let our AI analyze your PDF and create comprehensive study
                      materials including summary, flashcards, and quiz
                      questions.
                    </p>
                    <button
