    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-8 mt-8">
          {/* Web Upload Form */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-8 flex-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {selectedFile ? (
                    <div className="flex flex-col items-center">
                      ...
                      <button
                        ...
                        className="text-sm text-red-600 dark:text-red-500 hover:text-red-800 dark:hover:text-red-400 flex items-center"
                      >
                    ...
                    <>
                      <div className="bg-purple-100 dark:bg-purple-900/30 p-3 rounded-full inline-flex mb-4">
                        <CloudUpload className="w-8 h-8 text-purple-600 dark:text-purple-500" />
                      </div>
              ...
              <div>
               ...
               appearance-none bg-white dark:bg-gray-700 cursor-pointer text-gray-900 dark:text-white"
                    required
                  >
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {tags.map((tag) => (
                    <div
                      key={tag}
                      className="inline-flex items-center bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 px-3 py-1.5 rounded-full text-sm font-medium"
                    >
                      {tag}
                      <button
                        type="button"
                        onClick={() => removeTag(tag)}
                        className="ml-1 text-purple-600 dark:text-purple-400 hover:text-purple-900 dark:hover:text-purple-200"
                      >
                        <X className="w-3 h-3" />
                      </button>
                    </div>
                ...
                <div className="flex">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-l-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                    />
                  </div>
                  <button
                    type="button"
                ...
                {/* Suggested Tags */}
                <div className="mt-3">
                  <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">Suggested Tags:</p>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl border border-blue-200 dark:border-blue-800 p-8 flex-1">
            <div className="flex items-center mb-6">
            ...
            <div className="mb-6">
              ...
              {/* How it works */}
              <div className="bg-white dark:bg-gray-800 rounded-xl p-5 mb-8 shadow-sm">
                ...
                <div className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                  <div className="flex items-center space-x-3">
                    <div className="w-7 h-7 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full flex items-center justify-center text-xs font-semibold flex-shrink-0">
                      1
                    </div>
              ...
              {/* Additional Info */}
              <div className="mt-5 p-4 bg-blue-100 dark:bg-blue-900/30 rounded-xl">
